  ...
  return (
    ...
    >
      ...
      <div className="relative z-30 mx-auto flex h-full max-w-7xl flex-col justify-between px-4 sm:px-6 lg:px-8 py-5 sm:py-7">
        ...
        {/* Center Premium Royal Glassmorphic Hero Card (No Black!) */}
        <div className="max-w-3xl pb-2 sm:pb-3 rounded-3xl bg-stone-900/40 backdrop-blur-2xl border-2 border-amber-300/40 p-5 sm:p-7 shadow-[0_12px_45px_rgba(217,119,6,0.3)] ring-1 ring-white/20">
          <div className="flex flex-wrap items-center gap-2 mb-3">
            <div className="inline-flex items-center gap-1.5 rounded-full bg-gradient-to-r from-amber-500 via-amber-600 to-orange-600 text-white px-3.5 py-1 text-xs font-black uppercase tracking-[0.18em] shadow-[0_4px_15px_rgba(217,119,6,0.5)] border border-amber-300/50">
              <Sparkles className="size-3.5 fill-amber-200 animate-pulse" />
              <span>{active.eyebrow}</span>
            </div>

            {active.tag && (
              <span className="rounded-full bg-amber-400/20 backdrop-blur-md border border-amber-300/60 px-3 py-1 text-[11px] font-black uppercase tracking-wider text-amber-200">
                ⭐ {active.tag}
              </span>
            )}
          </div>
          ...
          <h1
            key={active.title}
            className="font-display text-2xl sm:text-4xl md:text-5xl font-black text-white drop-shadow-[0_4px_16px_rgba(0,0,0,0.85)] tracking-tight leading-[1.14]"
          >
            {active.title}
          </h1>

          <p className="mt-2.5 max-w-2xl text-xs sm:text-sm md:text-base font-medium text-stone-100 drop-shadow-[0_2px_8px_rgba(0,0,0,0.8)] leading-relaxed">
            {active.subtitle}
          </p>
          ...
          <div className="mt-5 sm:mt-6 flex flex-wrap items-center gap-3 sm:gap-4">
            <Button
              asChild
              size="lg"
              className="btn-gold-glow rounded-full px-6 sm:px-8 py-3 text-sm sm:text-base font-black shadow-[0_10px_30px_rgba(245,158,11,0.5)] border border-amber-200/50 cursor-pointer"
            >
              <a href="#book">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="inline-flex items-center gap-2 rounded-full bg-emerald-600 hover:bg-emerald-500 px-5 sm:px-6 py-3 text-sm sm:text-base font-bold text-white shadow-[0_10px_25px_rgba(5,150,105,0.4)] backdrop-blur-md transition-all hover:scale-104 border border-emerald-400/40 cursor-pointer"
              title="Book this exact stage on WhatsApp"
            >
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="rounded-full border-2 border-amber-300/90 bg-stone-900/60 text-amber-200 font-black backdrop-blur-xl hover:bg-amber-500 hover:text-stone-950 hover:border-amber-200 shadow-md cursor-pointer transition-all"
            >
              <a href="#gallery">
                <Images className="size-4.5 mr-1.5 text-amber-300" />
                View 55+ Mandaps & Stages
              </a>
            </Button>
          </div>
        </div>
            ...
            {slides.map((s, i) => (
              <button
                ...
                className={cn(
                  ...
                  i === index
                    ? "border-amber-400 ring-2 ring-amber-400 scale-108 z-10 opacity-100 shadow-[0_0_20px_rgba(245,158,11,0.7)]"
              ...
              >
                ...
                />
                {i === index && (
                  <div className="absolute inset-0 bg-gradient-to-t from-amber-500/30 to-transparent pointer-events-none ring-1 ring-inset ring-amber-300" />
                )}
              </button>
            ))}
          </div>
