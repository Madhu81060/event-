...
export const corePillars = [
  {
    ...
    subtitle: "రాయల్ డెకరేషన్ & స్టేజ్ డిజైన్స్",
    tagline: "Temple Mandapams, Luxury Stages & Thematic Sets",
    desc: "From traditional carved temple gopuram mandapams to modern luxury floral dome stages, concert lighting truss, and 3D themed sets.",
    icon: "Flower2",
    badge: "In-House Production",
    gradient: "from-amber-500 via-amber-600 to-amber-700",
    features: [
      "Traditional South Indian Vedic & Carved Temple Mandapams",
      "Floral Dome & Warm Candlelight Reception Stages",
      "Vibrant Haldi, Mehendi & Sangeet Lounge Canopies",
  ...
  },
  {
    ...
    subtitle: "సినిమాటిక్ 4K ఫోటోగ్రఫీ & ఆల్బమ్స్",
    tagline: "Candid Moments, 4K Cinema Films & Flush-Mount Albums",
    desc: "Capturing your priceless emotions with top wedding photographers, Sony FX3 4K cinema cameras, DJI drone shoots, and ultra HD flush-mount velvet albums.",
    icon: "Camera",
    badge: "4K Cinema & HDR",
  ...
  },
  {
    ...
    subtitle: "రాయల్ క్యాటరింగ్ & స్పెషల్ విందు",
    tagline: "Delicious Multi-Cuisine Food & 100% Hygienic Service",
    desc: "Authentic multi-cuisine culinary feasts prepared under strict hygiene standards with live interactive chaat, sweet, mocktail and tandoor counters.",
    icon: "UtensilsCrossed",
    badge: "100% Hygienic & Delicious",
    gradient: "from-emerald-600 via-teal-600 to-amber-600",
    features: [
      "Traditional Andhra Royal Banana Leaf Bhojanam",
      "Rich North Indian, Mughlai & Continental Dishes",
...
export const eventCategories = [
  {
    ...
    desc: "Sacred Vedic mandapams, luxury couple stages, 4K cinematography & royal catering.",
    icon: "Heart",
  },
  {
    id: "birthdays",
    ...
    desc: "Thematic 3D decor, custom balloon arches & joyful family party setups.",
    icon: "Cake",
  },
  {
    id: "corporate",
    ...
    desc: "Annual galas, stage truss, LED walls, audio-visuals & executive dining.",
    icon: "Briefcase",
  },
  {
    id: "private",
    title: "Family Celebrations & Utsavams",
    subtitle: "గృహప్రవేశం & పండుగ సంబరాలు",
    desc: "Half-saree, Dhoti ceremonies, Housewarmings & festive family gatherings.",
    icon: "Sparkles",
  },
];
